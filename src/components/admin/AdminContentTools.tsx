...
export function AdminContentTools({ lang, canBroadcast, canContent }: {
    ...
    setVideos(old => old.map((v, i) => i === index ? { ...v, mediaUrl: url } : v));
}
catch {
    setNotice(t.error);
}
