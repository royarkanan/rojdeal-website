  ...
  ar: {
    about: {
      ...
      sections: [
        ...
        {
          title: "دور المنصة",
          body: "RojDeal وسيط تقني للإعلانات والتواصل، وليس طرفًا في البيع أو الإيجار ولا يحتفظ بأموال الصفقات.",
        },
      ],
    },
    safety: {
      ...
      sections: [
        {
          title: "قبل الصفقة",
          body: "افحص السلعة والملكية وهوية الطرف الآخر، والتقِ في مكان آمن، واستخدم عقدًا مناسبًا للعقار أو السيارة.",
        },
        {
          title: "احمِ حسابك",
    ...
    terms: {
      ...
      sections: [
        {
          title: "الإعلانات",
          body: "يجب أن يصف الإعلان شيئًا حقيقيًا يحق للمعلن عرضه، وأن تكون الصور والسعر والموقع والحالة صحيحة. الإعلانات المضللة أو المكررة ممنوعة.",
        },
        {
        ...
        {
          title: "الصفقات",
          body: "يتحمل البائع والمشتري مسؤولية الفحص والعقد والدفع والتسليم والضرائب والالتزام بالقانون. RojDeal ليس طرفًا في الصفقة.",
        },
        {
